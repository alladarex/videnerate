...
class StartWindow(QMainWindow):
    ...
    def _load_projects(self) -> None:
        self._home_view.set_projects(list_project_titles())
    ...
    def _on_enter_narration(self) -> None:
        ...
        self._narration_view.set_project_title(next_project_title())
    ...
    def _on_generate_video_idea(self) -> None:
        video_idea = self._video_idea_view.video_idea()
        if not video_idea:
    ...
    def _on_create_project(self) -> None:
        narration = self._narration_view.narration()
        if not narration:
            QMessageBox.warning(
                self,
                "Missing input",
        ...
        project_title = self._narration_view.project_title()
        if not project_title:
            project_title = next_project_title()
    ...
    def _on_project_failed(self, exc: Exception) -> None:
        self._is_creating_project = False
        self._narration_view.set_loading(False)
        QMessageBox.critical(
            self,
